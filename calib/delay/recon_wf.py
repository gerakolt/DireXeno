...
delays=[ 0.     ,    -0.06196179 ,  1.39596335, -0.23545325,  0.7899076,
...
try:
    ...
    path='/storage/xenon/gerak/301120B/PulserC/'
    file=open(path+'out.DXD', 'rb')
...
while True:
    ...
    for i, pmt in enumerate(pmts):
        ...
        h, recon_wf, P=Recon_wf(waveform, wf, height_cuts[i], rise_time_cuts[i], spes[i], Init)
        H+=h
